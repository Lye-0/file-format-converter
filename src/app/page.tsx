...
export default function Home() {
  ...
  return (
    <main className="mx-auto flex min-h-svh w-full max-w-3xl flex-col items-center justify-start gap-4 px-4 py-7 sm:min-h-screen sm:justify-center sm:gap-8 sm:p-6">
      <h1 className="text-2xl font-bold sm:text-2xl">ファイル形式変換</h1>
